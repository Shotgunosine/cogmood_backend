...
CFG = dict(
    ...
    download=dl_dir,
    base_exe=os.path.join(base_exe_dir, 'NIMHCogMood.exe'),
    base_app=os.path.join(base_exe_dir, 'NIMHCogMood.app'),
    base_dmg=os.path.join(base_exe_dir, 'NIMHCogMood.dmg'),
